...
template <typename StlAllocatorContainer, typename POCAllocatorContainer>
void printTestStatus(const char *name, StlAllocatorContainer &stlContainer, POCAllocatorContainer &fastContainer)
{
...
int main()
{
    ...
    typedef POC::Allocator<DataType, growSize> MemoryPoolAllocator;
    typedef POC::Allocator<std::map<DataType, DataType>::value_type, growSize> MapMemoryPoolAllocator;
